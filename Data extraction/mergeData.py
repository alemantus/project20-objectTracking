...
while(cap.isOpened()):
    ...
    if(exists("../project_20_data/project_20_data/video2/frames/frame_"+str(i).zfill(6)+".xml")):
        shutil.move("../project_20_data/project_20_data/video2/frames/frame_"+str(i).zfill(6)+".xml","project_20_data/project_20_data/videoBoth/frames/frame_"+str(i+2717).zfill(6)+".xml")
